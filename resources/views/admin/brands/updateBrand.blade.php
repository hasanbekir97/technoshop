                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12 col-xl-12">
                                                                <div class="sub-title">Update Brand</div>
                                                                <input type="text" id="brandId" value="{{$brand['id']}}" style="visibility: hidden; display:none;">
                                                                <!-- Tab panes -->
                                                                <form id="brandEditForm" enctype='multipart/form-data'>
                                                                    ...
                                                                    <div class="userInformationArea">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="row">
                                                                                <div class="col-lg-12">
                                                                                    <label for="brandNameEditForm">Name <span>*</span></label>
                                                                                    <input type="text" id="brandNameEditForm" class="form-control" value="{{$brand['name']}}">
...
@section('scripts')
    <script type="text/javascript" src="{{asset('assets-admin/js/privateJs/updateBrand.js')}}"></script>
@endsection
